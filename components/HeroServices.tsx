...
export default function HeroServices() {
    return (
      <div className="container py-5">
        <div className="flex flex-col max-w-[960px] flex-1">
          <div className="relative isolate">
            <section
              ...
              "
              style={{
                // background image kept here for clarity; can move to CSS if preferred
                backgroundImage: `url(https://lh3.googleusercontent.com/aida-public/AB6AXuC3eHs6rmZhOhYqR8kXQESv2xE3pAS1iLu2QPBeBP-CjCXm0oPmFMJ2dPAiYx6RXXcg74Ip6zs0b6RtfHeP6hrey0nJx9pl9VUHyhLK7di-g_QqIJDmXAb5n-7jViX8h42LX0rpzuc9Fzj9mpNgolUbjMiBFsSor-pCHg6hciUcrJAUzHtfbd_UGX3291XkDHSvMuQlBaMDlkVLvUprmU5pYzMhSNWokd3p4gxMjCFaoXBVaBUjUJazyfo8Y5ve9M2JDHO-1szCsEo)`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                backgroundRepeat: 'no-repeat',
              }}
            >
              {/* gradient overlay via pseudo, but doing it inline for portability */}
              <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.10),rgba(0,0,0,0.40))] pointer-events-none" />

              <div className="relative z-10 w-full max-w-[720px] mx-auto">
                <h1 className="mx-auto mb-4 sm:mb-6 max-w-[38rem] text-balance font-extrabold leading-tight tracking-tight
                ...
                <div className="mx-auto grid w-full max-w-[520px] grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {/* Primary */}
                  <a
                    href="/quote"
                    className="
        ...
        <p className="text-sm text-gray-600">
          Pouzdani popravci i zamjena dijelova osiguravaju dugotrajan i učinkovit rad vašeg klima uređaja.
        </p>
      </div>
    </div>
  </div>
